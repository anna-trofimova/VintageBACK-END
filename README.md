...
| POST            | /myPage                  | {username, img, registrationDate, phone, email, myItems} | 201                | 400              | `Show user information`                                                                                                           |
| PUT            | /myPage/:id/edit         | {username,img,phone, email}                              | 201                | 400              | `Edit user information`                                                                                                           |
